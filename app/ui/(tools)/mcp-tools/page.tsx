...
import { ChatMessages } from "@/app/api/(tools)/mcp-tool/route";
              ...
              <div className="flex items-center justify-center h-full px-4 py-10">
                <div className="text-center">
                  ...
                  <p className="text-gray-500">
                    Send a message to begin chatting with the AI assistant. This
                    demo uses MockMCP to showcase MCP tool integrations!
                  </p>
                  <div className="mt-6">
                    <SuggestionButtons
